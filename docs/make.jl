...
makedocs(sitename = "Symbolics.jl",
         ...
         pages = [
             "Home" => "index.md",
             "getting_started.md",
             "Tutorials" => Any["tutorials/auto_parallel.md",
                                "tutorials/converting_to_C.md"],
             "Examples" => Any["examples/perturbation.md"],
             "Manual" => Any["manual/variables.md",
...
deploydocs(repo = "github.com/JuliaSymbolics/Symbolics.jl.git";
           push_preview = true)
