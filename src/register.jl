...
Overload approperate methods such that Symbolics can stop tracing into the
...
```
isdefined for the register function. Note that when defining multiple register
