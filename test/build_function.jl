...
h_oop = eval(h_str[1])
h_str_par = Symbolics.build_function(h, [a], [b], [c1, c2, c3], [d], [e], [g],
                                     parallel = Symbolics.MultithreadedForm())
h_str_3 = Symbolics.build_function(h, [a], [b], [c1, c2, c3], [d], [e], [g],
                                   iip_config = (false, true))
h_str_4 = Symbolics.build_function(h, [a], [b], [c1, c2, c3], [d], [e], [g],
...
h_par_rgf = Symbolics.build_function(h, [a], [b], [c1, c2, c3], [d], [e], [g],
                                     parallel = Symbolics.MultithreadedForm(),
                                     expression = false)
h_ip! = eval(h_str[2])
h_ip_skip! = eval(Symbolics.build_function(h, [a], [b], [c1, c2, c3], [d], [e], [g],
                                           skipzeros = true, fillzeros = false)[2])
h_ip_skip_par! = eval(Symbolics.build_function(h, [a], [b], [c1, c2, c3], [d], [e], [g],
                                               skipzeros = true,
                                               parallel = Symbolics.MultithreadedForm(),
                                               fillzeros = false)[2])
...
h_str_skip = Symbolics.build_function(h_skip, [a], [b], [c1, c2, c3], [], [], [g],
                                      checkbounds = true)
h_str_skip_cse = Symbolics.build_function(h_skip, [a], [b], [c1, c2, c3], [], [], [g],
...
h_str_scalar_cse = Symbolics.build_function(h_scalar, [a], [b], [c1, c2, c3], [d], [e], [g],
                                            cse = true)
...
let # Symbolics.jl#123
    ...
    @test_reference "target_functions/issue123.c" build_function(output_eq, x,
...
let
    ...
    header = expr -> let integrator = integrator
        Func([
                 expr.args[1],
                 expr.args[2],
                 DestructuredArgs(expr.args[3:end], integrator,
                                  inds = [:p]),
             ], [], expr.body)
    end
