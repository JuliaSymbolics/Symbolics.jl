...
@test isequal(partial_frac_decomposition((10x+35)/((x+4)^2), x), expand(10/(x+4) - 5/(x+4)^2))
@test_broken isequal(partial_frac_decomposition((6x+5)/((2x-1)^2), x), 3/(2x-1) + 8/(2x-1)^2)
@test isequal(partial_frac_decomposition((7x^2-17x+38)/((x+6)*(x-1)^2), x), expand(8/(x+6) - 1/(x-1) + 4/(x-1)^2))
