function (ˍ₋out, u)
    ...
    begin
        ...
        #= /home/runner/.julia/packages/SymbolicUtils/r1pzW/src/code.jl:422 =# @inbounds begin
                #= /home/runner/.julia/packages/SymbolicUtils/r1pzW/src/code.jl:418 =#
                ˍ₋out[1] = (+)((getindex)(u, 1), (*)(-1, (getindex)(u, 3)))
                ˍ₋out[2] = (+)((*)(-1, (getindex)(u, 2)), (^)((getindex)(u, 1), 2))
                ˍ₋out[3] = (+)((getindex)(u, 2), (getindex)(u, 3))
                #= /home/runner/.julia/packages/SymbolicUtils/r1pzW/src/code.jl:420 =#
                nothing
            end
    end
end